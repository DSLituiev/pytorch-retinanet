    ...
    for epoch_num in range(parser.epochs):
        ...
        for iter_num, data in enumerate(dataloader_train):
            try:
                ...
                print('''Epoch: {} | Iteration: {} / {:d} | Class loss: {:1.5f} | Regr loss: {:1.5f} | Running loss: {:1.5f}'''.format(epoch_num, iter_num, len(dataloader_train), float(classification_loss), float(regression_loss), np.mean(loss_hist)))
